...
p = person.Person(age = 98, params_file_path="/ssd/Howard/vaccine-cost-model/media/tmp/09f65a70ca6911ebbd2ae41f1345dc74/input_params.json")
...
m = model.VaccineModel("/ssd/Howard/vaccine-cost-model/media/tmp/09f65a70ca6911ebbd2ae41f1345dc74/input_params.json")
m.one_day_passed()
m.one_day_passed()
m.one_day_passed()
m.one_day_passed()
